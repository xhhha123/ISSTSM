<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TSManager.aspx.cs" Inherits="ISSTSM.Views.Admin.TSManager" %>
     ...
     <script type="text/javascript">
         ...
         $(function () {
             $("#dg").datagrid({
                 heigth: 700,
                 idField: 'ID',
                 url: '/Actions/TimeSheetHandler.ashx?view=admin&&t=loadAdmin',
                 singleSelect: true,
                 fitColumns: true,
                 nowrap: true,
                 height: '450',
